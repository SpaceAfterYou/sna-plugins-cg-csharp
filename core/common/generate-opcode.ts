import type { OpcodeGroupList } from '@/datatypes/opcode/group/list'
import type { ConfigPair } from '../../types/config-pair'
import { nameOf } from '../enum/name-of'
import { save } from '../save'

function generate(list: OpcodeGroupList) {
  const operators = []
  const constructors = []
...
export async function generateOpcode(common: ConfigPair, _enum: ConfigPair, list: OpcodeGroupList) {
